...
def extract_img_train():
    metadata_path = 'ytf_train_meta.csv'

    features_file = 'ytf_mxnet_images.csv'
    features_file_bin = 'ytf_mxnet_images_bin.npz'
    label_enc_file = 'label_enc'
...
def extract_frames():
    metadata_path = 'ytf_frames_meta.csv'

    features_file = 'ytf_mxnet_frames.csv'
    features_file_bin = 'ytf_mxnet_frames_bin.npz'
    label_enc_file = 'label_enc'
